...
#Ajustar isto de modo a q depois de editar os dados faça um refresh à página e mostre os dados atualizados
...
if email in list(client_data['email']) and username in list(client_data['username']) and st.session_state['Edit'] == 0:
    show_client_data()
